...
var OpCodesCB = map[uint8]OpCode{
	...
	0x06: NewOpCode(0x06, "RLC (HL)", 2, 16, []func(cpu *CPU){
		...
		func(cpu *CPU) { cpu.bus.Write(cpu.regs.getHL(), RLC(cpu, cpu.e)) },
	}),
	...
	0x0e: NewOpCode(0x0e, "RRC (HL)", 2, 16, []func(cpu *CPU){
		func(cpu *CPU) { cpu.e = cpu.bus.Read(cpu.regs.getHL()) },
		func(cpu *CPU) { cpu.bus.Write(cpu.regs.getHL(), RRC(cpu, cpu.e)) },
	}),
	...
	0x16: NewOpCode(0x16, "RL (HL)", 2, 16, []func(cpu *CPU){
		func(cpu *CPU) { cpu.e = cpu.bus.Read(cpu.regs.getHL()) },
		func(cpu *CPU) { cpu.bus.Write(cpu.regs.getHL(), RL(cpu, cpu.e)) },
	}),
	...
	0x1e: NewOpCode(0x1e, "RR (HL)", 2, 16, []func(cpu *CPU){
		func(cpu *CPU) { cpu.e = cpu.bus.Read(cpu.regs.getHL()) },
		func(cpu *CPU) { cpu.bus.Write(cpu.regs.getHL(), RR(cpu, cpu.e)) },
	}),
	...
	0x26: NewOpCode(0x26, "SLA (HL)", 2, 16, []func(cpu *CPU){
		func(cpu *CPU) { cpu.e = cpu.bus.Read(cpu.regs.getHL()) },
		func(cpu *CPU) { cpu.bus.Write(cpu.regs.getHL(), SLA(cpu, cpu.e)) },
	}),
	...
	0x2e: NewOpCode(0x2e, "SRA (HL)", 2, 16, []func(cpu *CPU){
		func(cpu *CPU) { cpu.e = cpu.bus.Read(cpu.regs.getHL()) },
		func(cpu *CPU) { cpu.bus.Write(cpu.regs.getHL(), SRA(cpu, cpu.e)) },
	}),
	...
	0x36: NewOpCode(0x36, "SWAP (HL)", 2, 16, []func(cpu *CPU){
		func(cpu *CPU) { cpu.e = cpu.bus.Read(cpu.regs.getHL()) },
		func(cpu *CPU) { cpu.bus.Write(cpu.regs.getHL(), SWAP(cpu, cpu.e)) },
	}),
	...
	0x3e: NewOpCode(0x3e, "SRL (HL)", 2, 16, []func(cpu *CPU){
		func(cpu *CPU) { cpu.e = cpu.bus.Read(cpu.regs.getHL()) },
		func(cpu *CPU) { cpu.bus.Write(cpu.regs.getHL(), SRL(cpu, cpu.e)) },
	}),
	...
	0x46: NewOpCode(0x46, "BIT 0,(HL)", 2, 12, []func(cpu *CPU){
		func(cpu *CPU) { BIT(cpu, cpu.bus.Read(cpu.regs.getHL()), 0) },
	}),
	...
	0x4e: NewOpCode(0x4e, "BIT 1,(HL)", 2, 12, []func(cpu *CPU){
		func(cpu *CPU) { BIT(cpu, cpu.bus.Read(cpu.regs.getHL()), 1) },
	}),
	...
	0x56: NewOpCode(0x56, "BIT 2,(HL)", 2, 12, []func(cpu *CPU){
		func(cpu *CPU) { BIT(cpu, cpu.bus.Read(cpu.regs.getHL()), 2) },
	}),
	...
	0x5e: NewOpCode(0x5e, "BIT 3,(HL)", 2, 12, []func(cpu *CPU){
		func(cpu *CPU) { BIT(cpu, cpu.bus.Read(cpu.regs.getHL()), 3) },
	}),
	...
	0x66: NewOpCode(0x66, "BIT 4,(HL)", 2, 12, []func(cpu *CPU){
		func(cpu *CPU) { BIT(cpu, cpu.bus.Read(cpu.regs.getHL()), 4) },
	}),
	...
	0x6e: NewOpCode(0x6e, "BIT 5,(HL)", 2, 12, []func(cpu *CPU){
		func(cpu *CPU) { BIT(cpu, cpu.bus.Read(cpu.regs.getHL()), 5) },
	}),
	...
	0x76: NewOpCode(0x76, "BIT 6,(HL)", 2, 12, []func(cpu *CPU){
		func(cpu *CPU) { BIT(cpu, cpu.bus.Read(cpu.regs.getHL()), 6) },
	}),
	...
	0x7e: NewOpCode(0x7e, "BIT 7,(HL)", 2, 12, []func(cpu *CPU){
		func(cpu *CPU) { BIT(cpu, cpu.bus.Read(cpu.regs.getHL()), 7) },
	}),
	...
	0x86: NewOpCode(0x86, "RES 0,(HL)", 2, 16, []func(cpu *CPU){
		func(cpu *CPU) { cpu.e = cpu.bus.Read(cpu.regs.getHL()) },
		func(cpu *CPU) { cpu.bus.Write(cpu.regs.getHL(), RES(cpu.e, 0)) },
	}),
	...
	0x8e: NewOpCode(0x8e, "RES 1,(HL)", 2, 16, []func(cpu *CPU){
		func(cpu *CPU) { cpu.e = cpu.bus.Read(cpu.regs.getHL()) },
		func(cpu *CPU) { cpu.bus.Write(cpu.regs.getHL(), RES(cpu.e, 1)) },
	}),
	...
	0x96: NewOpCode(0x96, "RES 2,(HL)", 2, 16, []func(cpu *CPU){
		func(cpu *CPU) { cpu.e = cpu.bus.Read(cpu.regs.getHL()) },
		func(cpu *CPU) { cpu.bus.Write(cpu.regs.getHL(), RES(cpu.e, 2)) },
	}),
	...
	0x9e: NewOpCode(0x9e, "RES 3,(HL)", 2, 16, []func(cpu *CPU){
		func(cpu *CPU) { cpu.e = cpu.bus.Read(cpu.regs.getHL()) },
		func(cpu *CPU) { cpu.bus.Write(cpu.regs.getHL(), RES(cpu.e, 3)) },
	}),
	...
	0xa6: NewOpCode(0xa6, "RES 4,(HL)", 2, 16, []func(cpu *CPU){
		func(cpu *CPU) { cpu.e = cpu.bus.Read(cpu.regs.getHL()) },
		func(cpu *CPU) { cpu.bus.Write(cpu.regs.getHL(), RES(cpu.e, 4)) },
	}),
	...
	0xae: NewOpCode(0xae, "RES 5,(HL)", 2, 16, []func(cpu *CPU){
		func(cpu *CPU) { cpu.e = cpu.bus.Read(cpu.regs.getHL()) },
		func(cpu *CPU) { cpu.bus.Write(cpu.regs.getHL(), RES(cpu.e, 5)) },
	}),
	...
	0xb6: NewOpCode(0xb6, "RES 6,(HL)", 2, 16, []func(cpu *CPU){
		func(cpu *CPU) { cpu.e = cpu.bus.Read(cpu.regs.getHL()) },
		func(cpu *CPU) { cpu.bus.Write(cpu.regs.getHL(), RES(cpu.e, 6)) },
	}),
	...
	0xbe: NewOpCode(0xbe, "RES 7,(HL)", 2, 16, []func(cpu *CPU){
		func(cpu *CPU) { cpu.e = cpu.bus.Read(cpu.regs.getHL()) },
		func(cpu *CPU) { cpu.bus.Write(cpu.regs.getHL(), RES(cpu.e, 7)) },
	}),
	...
	0xc6: NewOpCode(0xc6, "SET 0,(HL)", 2, 16, []func(cpu *CPU){
		func(cpu *CPU) { cpu.e = cpu.bus.Read(cpu.regs.getHL()) },
		func(cpu *CPU) { cpu.bus.Write(cpu.regs.getHL(), SET(cpu.e, 0)) },
	}),
	...
	0xce: NewOpCode(0xce, "SET 1,(HL)", 2, 16, []func(cpu *CPU){
		func(cpu *CPU) { cpu.e = cpu.bus.Read(cpu.regs.getHL()) },
		func(cpu *CPU) { cpu.bus.Write(cpu.regs.getHL(), SET(cpu.e, 1)) },
	}),
	...
	0xd6: NewOpCode(0xd6, "SET 2,(HL)", 2, 16, []func(cpu *CPU){
		func(cpu *CPU) { cpu.e = cpu.bus.Read(cpu.regs.getHL()) },
		func(cpu *CPU) { cpu.bus.Write(cpu.regs.getHL(), SET(cpu.e, 2)) },
	}),
	...
	0xde: NewOpCode(0xde, "SET 3,(HL)", 2, 16, []func(cpu *CPU){
		func(cpu *CPU) { cpu.e = cpu.bus.Read(cpu.regs.getHL()) },
		func(cpu *CPU) { cpu.bus.Write(cpu.regs.getHL(), SET(cpu.e, 3)) },
	}),
	...
	0xe6: NewOpCode(0xe6, "SET 4,(HL)", 2, 16, []func(cpu *CPU){
		func(cpu *CPU) { cpu.e = cpu.bus.Read(cpu.regs.getHL()) },
		func(cpu *CPU) { cpu.bus.Write(cpu.regs.getHL(), SET(cpu.e, 4)) },
	}),
	...
	0xee: NewOpCode(0xee, "SET 5,(HL)", 2, 16, []func(cpu *CPU){
		func(cpu *CPU) { cpu.e = cpu.bus.Read(cpu.regs.getHL()) },
		func(cpu *CPU) { cpu.bus.Write(cpu.regs.getHL(), SET(cpu.e, 5)) },
	}),
	...
	0xf6: NewOpCode(0xf6, "SET 6,(HL)", 2, 16, []func(cpu *CPU){
		func(cpu *CPU) { cpu.e = cpu.bus.Read(cpu.regs.getHL()) },
		func(cpu *CPU) { cpu.bus.Write(cpu.regs.getHL(), SET(cpu.e, 6)) },
	}),
	...
	0xfe: NewOpCode(0xfe, "SET 7,(HL)", 2, 16, []func(cpu *CPU){
		func(cpu *CPU) { cpu.e = cpu.bus.Read(cpu.regs.getHL()) },
		func(cpu *CPU) { cpu.bus.Write(cpu.regs.getHL(), SET(cpu.e, 7)) },
	}),
}
