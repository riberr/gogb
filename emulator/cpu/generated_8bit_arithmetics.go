...
var OpCodes8bitArithmeticsGenerated = map[uint8]OpCode{
    ...
    0x86: NewOpCode(0x86, "ADD A,(HL)", 1, 8, []func(cpu *CPU){func(cpu *CPU) {add(cpu, memory.BusRead(cpu.regs.getHL()))}}),
    0x87: NewOpCode(0x87, "ADD A,A", 1, 4, []func(cpu *CPU){func(cpu *CPU) {add(cpu, cpu.regs.a)}}),
    0xc6: NewOpCode(0xc6, "ADD A,u8", 2, 8, []func(cpu *CPU){func(cpu *CPU) {add(cpu, memory.BusRead(cpu.pc)); cpu.pc++}}),
    ...
    0x8e: NewOpCode(0x8e, "ADC A,(HL)", 1, 8, []func(cpu *CPU){func(cpu *CPU) {adc(cpu, memory.BusRead(cpu.regs.getHL()))}}),
    0x8f: NewOpCode(0x8f, "ADC A,A", 1, 4, []func(cpu *CPU){func(cpu *CPU) {adc(cpu, cpu.regs.a)}}),
    0xce: NewOpCode(0xce, "ADC A,u8", 2, 8, []func(cpu *CPU){func(cpu *CPU) {adc(cpu, memory.BusRead(cpu.pc)); cpu.pc++}}),
    ...
    0x96: NewOpCode(0x96, "SUB A,(HL)", 1, 8, []func(cpu *CPU){func(cpu *CPU) {sub(cpu, memory.BusRead(cpu.regs.getHL()))}}),
    0x97: NewOpCode(0x97, "SUB A,A", 1, 4, []func(cpu *CPU){func(cpu *CPU) {sub(cpu, cpu.regs.a)}}),
    0xd6: NewOpCode(0xd6, "SUB A,u8", 2, 8, []func(cpu *CPU){func(cpu *CPU) {sub(cpu, memory.BusRead(cpu.pc)); cpu.pc++}}),
    ...
    0x9e: NewOpCode(0x9e, "SBC A,(HL)", 1, 8, []func(cpu *CPU){func(cpu *CPU) {sbc(cpu, memory.BusRead(cpu.regs.getHL()))}}),
    0x9f: NewOpCode(0x9f, "SBC A,A", 1, 4, []func(cpu *CPU){func(cpu *CPU) {sbc(cpu, cpu.regs.a)}}),
    0xde: NewOpCode(0xde, "SBC A,u8", 2, 8, []func(cpu *CPU){func(cpu *CPU) {sbc(cpu, memory.BusRead(cpu.pc)); cpu.pc++}}),
    ...
    0xbe: NewOpCode(0xbe, "CP A,(HL)", 1, 8, []func(cpu *CPU){func(cpu *CPU) {cp(cpu, memory.BusRead(cpu.regs.getHL()))}}),
    0xbf: NewOpCode(0xbf, "CP A,A", 1, 4, []func(cpu *CPU){func(cpu *CPU) {cp(cpu, cpu.regs.a)}}),
    0xfe: NewOpCode(0xfe, "CP A,u8", 2, 8, []func(cpu *CPU){func(cpu *CPU) {cp(cpu, memory.BusRead(cpu.pc)); cpu.pc++}}),
    ...
    0xa6: NewOpCode(0xa6, "AND A,(HL)", 1, 8, []func(cpu *CPU){func(cpu *CPU) {and(cpu, memory.BusRead(cpu.regs.getHL()))}}),
    0xa7: NewOpCode(0xa7, "AND A,A", 1, 4, []func(cpu *CPU){func(cpu *CPU) {and(cpu, cpu.regs.a)}}),
    0xe6: NewOpCode(0xe6, "AND A,u8", 2, 8, []func(cpu *CPU){func(cpu *CPU) {and(cpu, memory.BusRead(cpu.pc)); cpu.pc++}}),
    ...
    0xb6: NewOpCode(0xb6, "OR A,(HL)", 1, 8, []func(cpu *CPU){func(cpu *CPU) {or(cpu, memory.BusRead(cpu.regs.getHL()))}}),
    0xb7: NewOpCode(0xb7, "OR A,A", 1, 4, []func(cpu *CPU){func(cpu *CPU) {or(cpu, cpu.regs.a)}}),
    0xf6: NewOpCode(0xf6, "OR A,u8", 2, 8, []func(cpu *CPU){func(cpu *CPU) {or(cpu, memory.BusRead(cpu.pc)); cpu.pc++}}),
    ...
    0xae: NewOpCode(0xae, "XOR A,(HL)", 1, 8, []func(cpu *CPU){func(cpu *CPU) {xor(cpu, memory.BusRead(cpu.regs.getHL()))}}),
