...
var OpCodes16bitLoadGenerated = map[uint8]OpCode{
	...
	0x01: NewOpCode(0x01, "LD BC,u16", 3, 12, []func(cpu *CPU){
		...
		func(cpu *CPU) { msb = memory.BusRead(cpu.pc); cpu.pc++; cpu.regs.setBC(utils.ToUint16(lsb, msb)) },
	}),
	0x11: NewOpCode(0x11, "LD DE,u16", 3, 12, []func(cpu *CPU){
		func(cpu *CPU) { lsb = memory.BusRead(cpu.pc); cpu.pc++ },
		func(cpu *CPU) { msb = memory.BusRead(cpu.pc); cpu.pc++; cpu.regs.setDE(utils.ToUint16(lsb, msb)) },
	}),
	0x21: NewOpCode(0x21, "LD HL,u16", 3, 12, []func(cpu *CPU){
		func(cpu *CPU) { lsb = memory.BusRead(cpu.pc); cpu.pc++ },
		func(cpu *CPU) { msb = memory.BusRead(cpu.pc); cpu.pc++; cpu.regs.setHL(utils.ToUint16(lsb, msb)) },
	}),
	0x31: NewOpCode(0x31, "LD SP,u16", 3, 12, []func(cpu *CPU){
		func(cpu *CPU) { lsb = memory.BusRead(cpu.pc); cpu.pc++ },
		func(cpu *CPU) { msb = memory.BusRead(cpu.pc); cpu.pc++; cpu.sp = utils.ToUint16(lsb, msb) },
	}),
	...
	0x08: NewOpCode(0x08, "LD (u16),SP", 3, 20, []func(cpu *CPU){
		...
		func(cpu *CPU) { memory.BusWrite(utils.ToUint16(lsb, msb), utils.Lsb(cpu.sp)) },
		func(cpu *CPU) { memory.BusWrite(utils.ToUint16(lsb, msb)+1, utils.Msb(cpu.sp)) },
	}),
	...
	0xc5: NewOpCode(0xc5, "PUSH BC", 1, 16, []func(cpu *CPU){
		func(cpu *CPU) { cpu.sp-- },
		func(cpu *CPU) { memory.BusWrite(cpu.sp, utils.Msb(cpu.regs.getBC())); cpu.sp-- },
		func(cpu *CPU) { memory.BusWrite(cpu.sp, utils.Lsb(cpu.regs.getBC())) },
	}),
	0xd5: NewOpCode(0xd5, "PUSH DE", 1, 16, []func(cpu *CPU){
		func(cpu *CPU) { cpu.sp-- },
		func(cpu *CPU) { memory.BusWrite(cpu.sp, utils.Msb(cpu.regs.getDE())); cpu.sp-- },
		func(cpu *CPU) { memory.BusWrite(cpu.sp, utils.Lsb(cpu.regs.getDE())) },
	}),
	0xe5: NewOpCode(0xe5, "PUSH HL", 1, 16, []func(cpu *CPU){
		func(cpu *CPU) { cpu.sp-- },
		func(cpu *CPU) { memory.BusWrite(cpu.sp, utils.Msb(cpu.regs.getHL())); cpu.sp-- },
		func(cpu *CPU) { memory.BusWrite(cpu.sp, utils.Lsb(cpu.regs.getHL())) },
	}),
	0xf5: NewOpCode(0xf5, "PUSH AF", 1, 16, []func(cpu *CPU){
		func(cpu *CPU) { cpu.sp-- },
		func(cpu *CPU) { memory.BusWrite(cpu.sp, utils.Msb(cpu.regs.getAF())); cpu.sp-- },
		func(cpu *CPU) { memory.BusWrite(cpu.sp, utils.Lsb(cpu.regs.getAF())) },
	}),
