...
var OpCodesGenerated = map[uint8]OpCode{
	// ~~~~~~~~~~~~~~~~~~~~~~~~~~
	// 8BIT LOAD
	// ~~~~~~~~~~~~~~~~~~~~~~~~~~
	...
	0x06: NewOpCode(0x06, "LD B,u8", 2, 8, []func(cpu *CPU){func(cpu *CPU) {cpu.regs.b = busRead(cpu.pc); cpu.pc++}}),
	0x0e: NewOpCode(0x0e, "LD C,u8", 2, 8, []func(cpu *CPU){func(cpu *CPU) {cpu.regs.c = busRead(cpu.pc); cpu.pc++}}),
	0x16: NewOpCode(0x16, "LD D,u8", 2, 8, []func(cpu *CPU){func(cpu *CPU) {cpu.regs.d = busRead(cpu.pc); cpu.pc++}}),
	0x1e: NewOpCode(0x1e, "LD E,u8", 2, 8, []func(cpu *CPU){func(cpu *CPU) {cpu.regs.e = busRead(cpu.pc); cpu.pc++}}),
	0x26: NewOpCode(0x26, "LD H,u8", 2, 8, []func(cpu *CPU){func(cpu *CPU) {cpu.regs.h = busRead(cpu.pc); cpu.pc++}}),
	0x2e: NewOpCode(0x2e, "LD L,u8", 2, 8, []func(cpu *CPU){func(cpu *CPU) {cpu.regs.l = busRead(cpu.pc); cpu.pc++}}),
	0x3e: NewOpCode(0x3e, "LD A,u8", 2, 8, []func(cpu *CPU){func(cpu *CPU) {cpu.regs.a = busRead(cpu.pc); cpu.pc++}}),

	// Load register (indirect HL)
	0x46: NewOpCode(0x46, "LD B,(HL)", 1, 8, []func(cpu *CPU){func(cpu *CPU) {cpu.regs.b = busRead(cpu.regs.getHL())}}),
	0x4e: NewOpCode(0x4e, "LD C,(HL)", 1, 8, []func(cpu *CPU){func(cpu *CPU) {cpu.regs.c = busRead(cpu.regs.getHL())}}),
	0x56: NewOpCode(0x56, "LD D,(HL)", 1, 8, []func(cpu *CPU){func(cpu *CPU) {cpu.regs.d = busRead(cpu.regs.getHL())}}),
	0x5e: NewOpCode(0x5e, "LD E,(HL)", 1, 8, []func(cpu *CPU){func(cpu *CPU) {cpu.regs.e = busRead(cpu.regs.getHL())}}),
	0x66: NewOpCode(0x66, "LD H,(HL)", 1, 8, []func(cpu *CPU){func(cpu *CPU) {cpu.regs.h = busRead(cpu.regs.getHL())}}),
	0x6e: NewOpCode(0x6e, "LD L,(HL)", 1, 8, []func(cpu *CPU){func(cpu *CPU) {cpu.regs.l = busRead(cpu.regs.getHL())}}),
	0x7e: NewOpCode(0x7e, "LD A,(HL)", 1, 8, []func(cpu *CPU){func(cpu *CPU) {cpu.regs.a = busRead(cpu.regs.getHL())}}),

	// Load from register (indirect HL)
	0x70: NewOpCode(0x70, "LD (HL),B", 1, 8, []func(cpu *CPU){func(cpu *CPU) {busWrite(cpu.regs.getHL(), cpu.regs.b)}}),
	0x71: NewOpCode(0x71, "LD (HL),C", 1, 8, []func(cpu *CPU){func(cpu *CPU) {busWrite(cpu.regs.getHL(), cpu.regs.c)}}),
	0x72: NewOpCode(0x72, "LD (HL),D", 1, 8, []func(cpu *CPU){func(cpu *CPU) {busWrite(cpu.regs.getHL(), cpu.regs.d)}}),
	0x73: NewOpCode(0x73, "LD (HL),E", 1, 8, []func(cpu *CPU){func(cpu *CPU) {busWrite(cpu.regs.getHL(), cpu.regs.e)}}),
	0x74: NewOpCode(0x74, "LD (HL),H", 1, 8, []func(cpu *CPU){func(cpu *CPU) {busWrite(cpu.regs.getHL(), cpu.regs.h)}}),
	0x75: NewOpCode(0x75, "LD (HL),L", 1, 8, []func(cpu *CPU){func(cpu *CPU) {busWrite(cpu.regs.getHL(), cpu.regs.l)}}),
	0x77: NewOpCode(0x77, "LD (HL),A", 1, 8, []func(cpu *CPU){func(cpu *CPU) {busWrite(cpu.regs.getHL(), cpu.regs.a)}}),

	// Various 8bit loads
	0x02: NewOpCode(0x02, "LD (BC),A", 1, 8, []func(cpu *CPU){func(cpu *CPU) {busWrite(cpu.regs.getBC(), cpu.regs.a)}}),
	0x0a: NewOpCode(0x0a, "LD A,(BC)", 1, 8, []func(cpu *CPU){func(cpu *CPU) {cpu.regs.a = busRead(cpu.regs.getBC())}}),
	0x12: NewOpCode(0x12, "LD (DE),A", 1, 8, []func(cpu *CPU){func(cpu *CPU) {busWrite(cpu.regs.getDE(), cpu.regs.a)}}),
	0x1a: NewOpCode(0x1a, "LD A,(DE)", 1, 8, []func(cpu *CPU){func(cpu *CPU) {cpu.regs.a = busRead(cpu.regs.getDE())}}),
	0x22: NewOpCode(0x22, "LD (HL+),A", 1, 8, []func(cpu *CPU){func(cpu *CPU) {busWrite(cpu.regs.getHL(), cpu.regs.a); cpu.pc++}}),
	0x2a: NewOpCode(0x2a, "LD A,(HL+)", 1, 8, []func(cpu *CPU){func(cpu *CPU) {cpu.regs.a = busRead(cpu.regs.getHL()); cpu.pc++}}),
	0x32: NewOpCode(0x32, "LD (HL-),A", 1, 8, []func(cpu *CPU){func(cpu *CPU) {busWrite(cpu.regs.getHL(), cpu.regs.a); cpu.pc--}}),
	0x36: NewOpCode(0x36, "LD (HL),u8", 2, 12, []func(cpu *CPU){func(cpu *CPU) { lsb = busRead(cpu.pc); cpu.pc++ }, func(cpu *CPU) {busWrite(cpu.regs.getHL(), lsb)}}),
	0x3a: NewOpCode(0x3a, "LD A,(HL-)", 1, 8, []func(cpu *CPU){func(cpu *CPU) {cpu.regs.a = busRead(cpu.regs.getHL()); cpu.pc--}}),
	0xe0: NewOpCode(0xe0, "LD (FF00+u8),A", 2, 12, []func(cpu *CPU){func(cpu *CPU) { lsb = busRead(cpu.pc); cpu.pc++ }, func(cpu *CPU) { busWrite(utils.ToUint16(lsb, 0xFF), cpu.regs.a) }}),
	0xe2: NewOpCode(0xe2, "LD (FF00+C),A", 1, 8, []func(cpu *CPU){func(cpu *CPU) {busWrite(utils.ToUint16(cpu.regs.c, 0xFF), cpu.regs.a)}}),
	0xea: NewOpCode(0xea, "LD (u16),A", 3, 16, []func(cpu *CPU){func(cpu *CPU) { lsb = busRead(cpu.pc); cpu.pc++ }, func(cpu *CPU) { msb = busRead(cpu.pc); cpu.pc++ }, func(cpu *CPU) { busWrite(utils.ToUint16(lsb, msb), cpu.regs.a) }}),
	0xf0: NewOpCode(0xf0, "LD A,(FF00+u8)", 2, 12, []func(cpu *CPU){func(cpu *CPU) { lsb = busRead(cpu.pc); cpu.pc++ }, func(cpu *CPU) {cpu.regs.a = busRead(utils.ToUint16(lsb, 0xFF))}}),
	0xf2: NewOpCode(0xf2, "LD A,(FF00+C)", 1, 8, []func(cpu *CPU){func(cpu *CPU) {cpu.regs.a = busRead(utils.ToUint16(cpu.regs.c, 0xFF))}}),
	0xfa: NewOpCode(0xfa, "LD A,(u16)", 3, 16, []func(cpu *CPU){func(cpu *CPU) {lsb = busRead(cpu.pc); cpu.pc++}, func(cpu *CPU) {msb = busRead(cpu.pc); cpu.pc++}, func(cpu *CPU) {cpu.regs.a = busRead(utils.ToUint16(lsb, msb))}}),
