...
var OpCodes8bitLoadGenerated = map[uint8]OpCode{
	...
	0x06: NewOpCode(0x06, "LD B,u8", 2, 8, []func(cpu *CPU){func(cpu *CPU) { cpu.regs.b = cpu.bus.Read(cpu.pc); cpu.pc++ }}),
	0x0e: NewOpCode(0x0e, "LD C,u8", 2, 8, []func(cpu *CPU){func(cpu *CPU) { cpu.regs.c = cpu.bus.Read(cpu.pc); cpu.pc++ }}),
	0x16: NewOpCode(0x16, "LD D,u8", 2, 8, []func(cpu *CPU){func(cpu *CPU) { cpu.regs.d = cpu.bus.Read(cpu.pc); cpu.pc++ }}),
	0x1e: NewOpCode(0x1e, "LD E,u8", 2, 8, []func(cpu *CPU){func(cpu *CPU) { cpu.regs.e = cpu.bus.Read(cpu.pc); cpu.pc++ }}),
	0x26: NewOpCode(0x26, "LD H,u8", 2, 8, []func(cpu *CPU){func(cpu *CPU) { cpu.regs.h = cpu.bus.Read(cpu.pc); cpu.pc++ }}),
	0x2e: NewOpCode(0x2e, "LD L,u8", 2, 8, []func(cpu *CPU){func(cpu *CPU) { cpu.regs.l = cpu.bus.Read(cpu.pc); cpu.pc++ }}),
	0x3e: NewOpCode(0x3e, "LD A,u8", 2, 8, []func(cpu *CPU){func(cpu *CPU) { cpu.regs.a = cpu.bus.Read(cpu.pc); cpu.pc++ }}),

	// Load register (indirect HL)
	0x46: NewOpCode(0x46, "LD B,(HL)", 1, 8, []func(cpu *CPU){func(cpu *CPU) { cpu.regs.b = cpu.bus.Read(cpu.regs.getHL()) }}),
	0x4e: NewOpCode(0x4e, "LD C,(HL)", 1, 8, []func(cpu *CPU){func(cpu *CPU) { cpu.regs.c = cpu.bus.Read(cpu.regs.getHL()) }}),
	0x56: NewOpCode(0x56, "LD D,(HL)", 1, 8, []func(cpu *CPU){func(cpu *CPU) { cpu.regs.d = cpu.bus.Read(cpu.regs.getHL()) }}),
	0x5e: NewOpCode(0x5e, "LD E,(HL)", 1, 8, []func(cpu *CPU){func(cpu *CPU) { cpu.regs.e = cpu.bus.Read(cpu.regs.getHL()) }}),
	0x66: NewOpCode(0x66, "LD H,(HL)", 1, 8, []func(cpu *CPU){func(cpu *CPU) { cpu.regs.h = cpu.bus.Read(cpu.regs.getHL()) }}),
	0x6e: NewOpCode(0x6e, "LD L,(HL)", 1, 8, []func(cpu *CPU){func(cpu *CPU) { cpu.regs.l = cpu.bus.Read(cpu.regs.getHL()) }}),
	0x7e: NewOpCode(0x7e, "LD A,(HL)", 1, 8, []func(cpu *CPU){func(cpu *CPU) { cpu.regs.a = cpu.bus.Read(cpu.regs.getHL()) }}),

	// Load from register (indirect HL)
	0x70: NewOpCode(0x70, "LD (HL),B", 1, 8, []func(cpu *CPU){func(cpu *CPU) { cpu.bus.Write(cpu.regs.getHL(), cpu.regs.b) }}),
	0x71: NewOpCode(0x71, "LD (HL),C", 1, 8, []func(cpu *CPU){func(cpu *CPU) { cpu.bus.Write(cpu.regs.getHL(), cpu.regs.c) }}),
	0x72: NewOpCode(0x72, "LD (HL),D", 1, 8, []func(cpu *CPU){func(cpu *CPU) { cpu.bus.Write(cpu.regs.getHL(), cpu.regs.d) }}),
	0x73: NewOpCode(0x73, "LD (HL),E", 1, 8, []func(cpu *CPU){func(cpu *CPU) { cpu.bus.Write(cpu.regs.getHL(), cpu.regs.e) }}),
	0x74: NewOpCode(0x74, "LD (HL),H", 1, 8, []func(cpu *CPU){func(cpu *CPU) { cpu.bus.Write(cpu.regs.getHL(), cpu.regs.h) }}),
	0x75: NewOpCode(0x75, "LD (HL),L", 1, 8, []func(cpu *CPU){func(cpu *CPU) { cpu.bus.Write(cpu.regs.getHL(), cpu.regs.l) }}),
	0x77: NewOpCode(0x77, "LD (HL),A", 1, 8, []func(cpu *CPU){func(cpu *CPU) { cpu.bus.Write(cpu.regs.getHL(), cpu.regs.a) }}),

	// Various 8bit loads
	0x02: NewOpCode(0x02, "LD (BC),A", 1, 8, []func(cpu *CPU){func(cpu *CPU) { cpu.bus.Write(cpu.regs.getBC(), cpu.regs.a) }}),
	0x0a: NewOpCode(0x0a, "LD A,(BC)", 1, 8, []func(cpu *CPU){func(cpu *CPU) { cpu.regs.a = cpu.bus.Read(cpu.regs.getBC()) }}),
	0x12: NewOpCode(0x12, "LD (DE),A", 1, 8, []func(cpu *CPU){func(cpu *CPU) { cpu.bus.Write(cpu.regs.getDE(), cpu.regs.a) }}),
	0x1a: NewOpCode(0x1a, "LD A,(DE)", 1, 8, []func(cpu *CPU){func(cpu *CPU) { cpu.regs.a = cpu.bus.Read(cpu.regs.getDE()) }}),
